...
declare module '$env/static/private' {
	...
	export const npm_package_devDependencies_automd: string;
	export const npm_package_devDependencies_changelogen: string;
	export const npm_package_devDependencies_eslint: string;
	export const npm_package_devDependencies_eslint_config_unjs: string;
	export const npm_package_devDependencies_jiti: string;
	export const npm_package_devDependencies_prettier: string;
	export const npm_package_devDependencies_rollup_plugin_svelte: string;
	export const npm_package_devDependencies_svelte: string;
	export const npm_package_devDependencies_typescript: string;
	export const npm_package_devDependencies_unbuild: string;
...
declare module '$env/dynamic/private' {
	export const env: {
		...
		npm_package_devDependencies_automd: string;
		npm_package_devDependencies_changelogen: string;
		npm_package_devDependencies_eslint: string;
		npm_package_devDependencies_eslint_config_unjs: string;
		npm_package_devDependencies_jiti: string;
		npm_package_devDependencies_prettier: string;
		npm_package_devDependencies_rollup_plugin_svelte: string;
		npm_package_devDependencies_svelte: string;
		npm_package_devDependencies_typescript: string;
		npm_package_devDependencies_unbuild: string;
